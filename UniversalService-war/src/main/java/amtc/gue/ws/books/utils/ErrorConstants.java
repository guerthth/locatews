...
public class ErrorConstants {
	...
	/** partially OK statuscode for adding books */
	public static final int ADD_BOOK_PARTIAL_SUCCESS_CODE = 11;

	/** NOK statuscode for adding books */
	public static final int ADD_BOOK_FAILURE_CODE = 12;

	/** message for adding books */
	public static final String ADD_BOOK_SUCCESS_MSG = "Added book(s):";
	...
	public static final int RETRIEVE_BOOK_SUCCESS_CODE = 13;

	/** NOK statuscode for retrieving books */
	public static final int RETRIEVE_BOOK_FAILURE_CODE = 14;

	/** message for retrieving books */
	public static final String RETRIEVE_BOOK_SUCCESS_MSG = "Retrieved books for tag(s)";
	...
	public static final int DELETE_BOOK_SUCCESS_CODE = 15;
	...
	public static final String UNRECOGNIZED_INPUT_OBJECT_MSG = "Input object type not recognized";

	/** statuscode for unrecognnized persistence object */
	public static final int UNRECOGNIZED_INPUT_OBJECT_CODE = 17;

	/**	message for successful tag retrieval */
	public static final String RETRIEVE_TAGS_SUCCESS_MSG = "Found tags:";

	/**	status code for successful tag retrieval */
	public static final int RETRIEVE_TAGS_SUCCESS_CODE = 18;
