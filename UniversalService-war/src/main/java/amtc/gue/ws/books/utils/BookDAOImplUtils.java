...
public class BookDAOImplUtils {
	 ...
	 * 
	 * @param initialBookQuery the basic bookQuery
	 * @param bookEntity the BookEntity that is searched for
	...
	public static String buildSpecificBookQuery(String initialBookQuery,
		...
		if(bookEntity != null){
			if(bookEntity.getId() != null) {sb.append(" and be.id = :id");}
			if(bookEntity.getTitle() != null) {sb.append(" and be.title = :title");}
			if(bookEntity.getAuthor() != null) {sb.append(" and be.author = :author");}
			if(bookEntity.getPrice() != null) {sb.append(" and be.price = :price");}
			if(bookEntity.getISBN() != null){sb.append(" and be.ISBN = :ISBN");}
			if(bookEntity.getTags() != null) {sb.append(" and be.tags = :tags");}
			if(bookEntity.getDescription() != null) {sb.append(" and be.description = :description");}
		}
