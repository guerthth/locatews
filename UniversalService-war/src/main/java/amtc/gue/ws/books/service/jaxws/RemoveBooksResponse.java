...
@XmlRootElement(name = "removeBooksResponse", namespace = "http://service.books.ws.gue.amtc/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeBooksResponse", namespace = "http://service.books.ws.gue.amtc/")
