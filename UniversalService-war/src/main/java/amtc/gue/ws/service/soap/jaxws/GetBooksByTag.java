...
public class GetBooksByTag {
    ...
    private amtc.gue.ws.books.inout.Tags searchTags;
     ...
     *     returns Tags
     */
    public amtc.gue.ws.books.inout.Tags getSearchTags() {
     ...
     */
    public void setSearchTags(amtc.gue.ws.books.inout.Tags searchTags) {
