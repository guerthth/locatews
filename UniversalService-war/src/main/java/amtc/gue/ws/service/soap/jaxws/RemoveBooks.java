...
public class RemoveBooks {
    ...
    private amtc.gue.ws.books.inout.Books booksToRemove;
     ...
     *     returns Books
     */
    public amtc.gue.ws.books.inout.Books getBooksToRemove() {
     ...
     */
    public void setBooksToRemove(amtc.gue.ws.books.inout.Books booksToRemove) {
