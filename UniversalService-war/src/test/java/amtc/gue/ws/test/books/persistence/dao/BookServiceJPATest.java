...
/**
 * Super Testclass for all BookService JPA Testcases
 * 
 * @author Thomas
 *
 */
public abstract class BookServiceJPATest extends BaseDAOTest {

	protected static BookDAO bookEntityDAO;
	protected static BookDAO bookEntityDAONullUser;
	...
	protected static final String TEST_KEY_A = "testKeyA";
	...
	protected static final String BOOK_TITLE_FOR_TESTING = "BookTitleForTesting";
	protected static final String TAG_NAME_FOR_TESTING = "TagNameForTesting";
	...
	private static void setupBasicEnvironment() {
		...
		User user = new User();
		user.setId(TEST_USER_NAME);
		tagEntityDAO = new TagDAOImpl(emf);
		failureTagEntityDAO = new TagDAOImpl(null);
		bookEntityDAO = new BookDAOImpl(emf, user);
		bookEntityDAONullUser = new BookDAOImpl(emf, null);
		failureBookEntityDAO = new BookDAOImpl(null, null);
	...
	private void setupUserEntities() {
		...
		userEntity1.setKey(TEST_USER_NAME);
	}
}
