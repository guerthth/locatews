...
import amtc.gue.ws.test.books.persistence.dao.BookDAOJPATest;
import amtc.gue.ws.test.books.persistence.dao.TagDAOJPATest;
import amtc.gue.ws.test.books.util.BookPersistenceDelegatorUtilTest;
import amtc.gue.ws.test.books.util.BookServiceEntityMapperTest;
...
@RunWith(Suite.class)
@SuiteClasses({ BookGrabberTest.class, BookServiceTest.class,
		BookPersistenceDelegatorTest.class,
		BookPersistenceDelegatorUtilTest.class,
		BookServiceEntityMapperTest.class, BookDAOJPATest.class,
		BookDAOImplUtilTest.class, TagServiceTest.class,
		TagPersistenceDelegatorTest.class,
		TagPersistenceDelegatorUtilTest.class, TagDAOJPATest.class,
